...
export const SETTINGS_SEARCH_ITEMS: SettingsSearchItem[] = [
  ...
  },
  {
    ...
    keywords: ["OpenAI", "Anthropic", "Codex"],
  },
  {
    id: "ai.credentials",
    label: "AI credentials and ChatGPT sign-in",
    description: "Manage an API key or Codex subscription login.",
    path: "AI Assistant",
    section: "aiAssistant",
    targetId: "ai.credentials",
    keywords: ["API key", "account", "Codex", "OpenAI", "Anthropic", "login"],
  },
  {
    id: "ai.model",
    label: "AI model",
